...
- **Create a VM Instance on AWS**
  ...
  - Go to EC2 Instances and click **"Create Instance"**
  - Name: ``
  - Machine Type:
    - Series: `m7i-flex.large`
    - Preset: `Standard`
    - Memory: `10 GB RAM`
  - Boot Disk:
...
```bash
git config --global user.email "p1yushhhchawla2307@gmail.com"
git config --global user.name "p1yushhhh"
...
docker build -t AnimeRecommender-app:latest .
